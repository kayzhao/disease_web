...
public class SourceAtomClusterLite {
	...
	private void setContentViewMemberships(
			List<HashMap<String, Object>> contentViewMemberships) {

		this.contentViewMemberships = contentViewMemberships;

	}

	private void setSubsetMemberships(
			List<HashMap<String, Object>> subsetMemberships) {
