 ...
 */
package com.csu.bio.api.umls.cookbook;
...
public class CodeCrosswalk {
				...
				try {
					...
					for (SourceAtomClusterLite sourceAtomCluster : sourceAtomClusters) {
						...
						System.out.println(hpo + "|"
								+ sourceAtomCluster.getUi() + "|"
								+ sourceAtomCluster.getName());
	...
	public SourceAtomClusterLite[] CrossWalkCodes(String code,
			String targetSource) {
		...
		Response response = given()
				...
				.param("targetSource", "SNOMEDCT_US").when().get(path);
