...
public class RetrieveAtoms {
	...
	public void RetrieveAtoms() throws Exception {
		...
		// searching for CUI
		String path = System.getProperty("source") == null ? "/rest/content/"
				+ version + "/CUI/" + id + "/atoms" : "/rest/content/"
				+ version + "/source/" + source + "/" + id + "/atoms";
		AtomLite[] atoms;
		int page = 1;
		int pageCount;
		...
		do {
			...
			for (AtomLite atom : atoms) {
				...
				System.out
						.println("Source Concept: " + atom.getSourceConcept());
				System.out.println("Source Descriptor: "
						+ atom.getSourceDescriptor());
